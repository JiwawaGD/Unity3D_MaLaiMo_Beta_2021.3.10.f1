...
public partial class GameManager : MonoBehaviour
{
    ...
    public void GameEvent(GameEventID r_eventID)    // 遊戲事件
    {
        switch (r_eventID)
        {
            ...
            case GameEventID.S1_Photo_Frame:    // 破碎相框 
                ...
                audManager.Play("mirror_Breaking_Sound", false);
            ...
            case GameEventID.S1_Grandma_Door_Open:
                ...
                audManager.Play("the_sound_of_the_old_door_opening", false);
            ...
            case GameEventID.S1_Lotus_Paper:
                ...
                audManager.Play("gold_Paper", false);
                audManager.Play("get_Item_Sound", false);
            ...
            case GameEventID.S2_Grandma_Door_Close: //用力關門
                ...
                audManager.Play("door_Close", false);
    ...
    {
        audManager.Play("Opening_Scene", false);
